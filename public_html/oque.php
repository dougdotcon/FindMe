	...
	<div class="head">
		...
		<div class="menu">
			<ul class="sf-menu">
				...
				<li class="active"><a href="oque.php">O QUE �</a>	
				</li>
...
<div style="text-align:center; width:960px; margin:0 auto; padding-bottom:30px;">
  <h1>O QUE �?</h1><h4>Projeto LYLA</h4><br />

O Projeto FindMe �, em poucas palavras, um sistema que divulga dados de pessoas desaparecidas em redes sociais,
para maximizar as chances de uma identifica��o. De um lado os volunt�rios entram no site e, com apenas alguns cliques,
cedem suas contas de rede social. Do outro, respons�veis de pessoas desaparecidas cadastram os dados da pessoa
(incluindo fotos), e o FindMe conecta esses dois pontos.

Conhece os cartazes que eram pregados nas ruas perguntando por informa��es? Ent�o, agora eles est�o na Internet!
N�o gastam papel, n�o sujam e s�o muito mais eficientes. E � de gra�a!

E a divulga��o � feita de uma forma muito sutil. No Facebook � utilizada uma mensagem no mural, no Twitter � feito
um tweet e no Orkut, uma atividade. S�o no m�ximo duas publica��es por dia em hor�rios muito espa�ados,
n�o ficando nada atrelado ao seu perfil e sem ficar importunando seus amigos.

Parece pouco mas � uma forma muito eficiente de divulgar dados, e cada volunt�rio � muito importante!
Seja volunt�rio do ProjetFindMela e propague a esperan�a! 
            </div>
