...
<div style="width:960px; margin:0 auto; padding-bottom:30px;">
 <center> <h1>CADASTRO</h1><h4>Formul�rio de Cadastro</h4><br />

	Este � motivo de existir do ProjetFindMela. Coloque informa��es verdadeiras, concisas e deixe o sistema agir!<br><br><br></center>
<form action="cadDesap.php" method="POST" id="cadd">
		...
		<tr><td><b>Cor:</b> </td><td><select id="cor" class="cad" name="cor"><option selected="selected" value="branco">Branco</option><option value="negro">Negro</option><option value="asi�tico">Asi�tico</option><option value="ind�gena">Ind�gena</option><option value="mulato">Mulato</option></select></td></tr>
		...
		<tr><td><b>Tipo F�sico:</b> </td><td><select class="cad" id="tipo_fisico" name="tipo_fisico"><option selected="selected" value="obeso">Obeso</option><option value="acima do peso">Acima do peso</option><option value="normal">Normal</option><option value="magro">Magro</option><option value="muito magro">Muito magro</option></select></td></tr>
	...
	<div class="content_body">
			<div class="lower_container">
				...
				<div class="three_col_left home">
					...
					<p>N�o utilize o sistema para brincadeiras, insira informa��es verdadeiras sobre desaparecidos.</p>
					</center>
				...
				<div class="three_col home">
					...
					<h4 class="bottom_margin">Paci�ncia</h4>
					<p>Os dados ser�o verificados e por isso n�o entrar�o autom�ticamente no sistema; por isso n�o crie diversos cadastros, aguarde at� as informa��es serem aprovadas. </a></p>
				</div>
				
				<div class="three_col_right home">
					<div class="three_col_img"><img src="images/bd.png" alt="img"/></div>
					<h4 class="bottom_margin">Divulga��o</h4>
					<p>Ap�s os dados serem aprovados, eles come�ar�o a aparecer em redes sociais e na p�gina do projeto.</a></p>
				</div>
				<div class="clear"></div>
