...
class SocialService // conecta o id do token ao id do desaparecido
{
	...
	{		
		...
		{ /*
			case 'orkut':
				$ret = array();
				$ret[0]  = "Projeto FindMe - Dê qualquer informação sobre:";
				...
				$ret[1] .= "Ajude famílias e propague a esperança! Junte-se ao <a href=\"lyla.jotajunior.com\">Projeto FindMe</a>.";
				$ret[2]  = $fetch['foto'];
			break;*/
			case 'facebook':
				$ret     = array();
				...
				$ret[0] .= "\n\n Junte-se ao Projeto FindMe e propague a esperança!";
				$ret[1]  = $fetch['foto'];
